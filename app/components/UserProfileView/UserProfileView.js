      ...
      <div className={styles.header}>
        ...
        <div className={styles.infoCol}>
          ...
          <div className={styles.stats}>
            ...
            <button className={styles.stat} onClick={() => router.push(`/users/${userId}/follow?tab=followers`)}>
              <span className={styles.statNum}>{(profile.followerCount ?? 0).toLocaleString()}</span>
              <span className={styles.statLabel}>팔로워</span>
            </button>
            <button className={styles.stat} onClick={() => router.push(`/users/${userId}/follow?tab=followings`)}>
